...
class FilesListView(QListView):
    ...
    def contextMenuEvent(self, event):
        ...
        if index.isValid():
            ...
            #追加
            menu.addAction(self.win.actionPreview_Text)
            menu.addSeparator()
    ...
    def mouseDoubleClickEvent(self, event):
        ...
        # Shift＋ダブルクリック → 分割 (actionSplitFile)
        index = self.indexAt(event.pos())
